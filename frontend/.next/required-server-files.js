self.__SERVER_FILES_MANIFEST={
  ...
  "config": {
    ...
    "outputFileTracingRoot": "D:\\NetFlix_Analytics\\frontend",
    ...
    "turbopack": {
      "root": "D:\\NetFlix_Analytics\\frontend"
    },
    "distDirRoot": ".next",
    "_originalRewrites": {
      "beforeFiles": [],
      "afterFiles": [
        ...
        },
        {
          ...
          "destination": "http://localhost:8000/data/titles.json"
        }
      ],
      "fallback": []
    }
  },
  "appDir": "D:\\NetFlix_Analytics\\frontend",
  "relativeAppDir": "",
  "files": [
    ".next\\package.json",
