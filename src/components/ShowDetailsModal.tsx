                    ...
                    <div className="flex-grow space-y-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-gray-300 text-sm sm:text-base leading-relaxed font-light">
                          {tmdbData?.overview || show.description || "No description available."}
                        </p>
                      </div>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-3 border-t border-white/5 text-xs">
                          ...
                          <span className="text-white font-semibold">
                            {omdbData?.Director && omdbData.Director !== 'N/A'
                              ...
                              : tmdbData?.crew && tmdbData.crew.length > 0 
                                ...
                                : show.director || "Unknown Director"}
                          </span>
                        </div>
                        ...
                        {omdbData?.matched && (
                          <>
                            ...
                            <div className="sm:col-span-2">
                              ...
                              <span className="text-gray-300 font-medium">{omdbData.Language || show.language}</span>
                            </div>
                          </>
                        )}
                        ...
                        <div className="sm:col-span-2">
                          ...
                          <span className="text-gray-300 font-medium">
                            {omdbData?.Country && omdbData.Country !== 'N/A' ? omdbData.Country : show.country || "Not specified"}
                          </span>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="border-t border-white/5 pt-4">
                    ...
                    {isLoadingTmdb ? (
                      ...
                      <p className="text-gray-300 text-xs font-light leading-relaxed">
                        {show.cast || "No cast lists recorded in catalog."}
                      </p>
                    )}
                  </div>
                </div>
